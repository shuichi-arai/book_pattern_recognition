...
#  検索して修正箇所を探してください)
# 本program内でα(alpha)で表記されているものはテキストではaです．
# programで'a'というありふれた変数名を使うのを避けていますので，α→aと読み替えてください．
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--overwrap', type=float, default=0.0,
                        help='overwrap rate of 2 class data (default=0.0[no overwrap]) [0.0,1.0]')
